...
public class OjuLoginService extends AbstractLifeCycle implements LoginService
{
    private static final Logger Log = LoggerFactory.getLogger(OjuLoginService.class);
    private IdentityService _identityService = new DefaultIdentityService();
    private String _name;
    private UserManager userManager = XMPPServer.getInstance().getUserManager();

    protected OjuLoginService()
    {

    }

    public OjuLoginService(String name)
    {
        setName(name);
    }
    ...
    public UserIdentity login(String userName, Object credential, ServletRequest request)
    {
        ...
        subject.getPrincipals().add(new RolePrincipal("oju"));
        subject.setReadOnly();

        identity = _identityService.newUserIdentity(subject, userPrincipal, new String[] {"oju"});
        return identity;
    }
