...
copy galene.jar to the plugins folder in Openfire

## Set up a group

The plugin will auto-create galene group files in `groups/groupname.json` from groupchat rooms.
...
You should be able to access Galène at `https://localhost:7443`.  Connect
