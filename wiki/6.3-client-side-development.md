...
For server-side plugin development, see [Plugin Development Overview](./6.1-plugin-development-overview.md). For WebSocket proxy implementation details, see [WebSocket Implementation Details](./6.2-websocket-implementation-details.md). For administration interfaces, see [Admin Console Interface](./3.1-admin-console-interface.md).
