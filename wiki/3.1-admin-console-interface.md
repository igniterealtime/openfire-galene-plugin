...
For information about the underlying plugin architecture, see [Core Plugin Architecture](/igniterealtime/openfire-galene-plugin/4.1-core-plugin-architecture). For details about client-side interfaces, see [Web Client Interface](/igniterealtime/openfire-galene-plugin/3.2-web-client-interface).
