...
For information about the broader plugin architecture and WebSocket proxy implementation, see [Core Plugin Architecture](./4.1-core-plugin-architecture.md) and [WebSocket Proxy System](./4.2-websocket-proxy-system.md). For XMPP IQ handler implementation details, see [XMPP IQ Handlers](./8.2-xmpp-iq-handlers.md).
