...
For detailed protocol specifications, see [XEP-XXXX: In-Band SFU Sessions](./5.1-xep-xxxx:-in-band-sfu-sessions.md). For configuration of client-facing features, see [Advanced Configuration](./2.3-advanced-configuration.md).
