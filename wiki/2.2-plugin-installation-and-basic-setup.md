...
For information about building the plugin from source code, see [Building from Source](./2.1-building-from-source.md). For comprehensive configuration options and advanced settings, see [Advanced Configuration](./2.3-advanced-configuration.md).
...
1. **Advanced Configuration**: See [Advanced Configuration](./2.3-advanced-configuration.md) for MUC integration, TURN server setup, and network optimization
2. **Admin Interface**: Explore the full admin console features covered in [Admin Console Interface](./3.1-admin-console-interface.md)
3. **Client Integration**: Set up XMPP clients using the protocols described in [XMPP Client Integration](./3.3-xmpp-client-integration.md)
4. **Web Client**: Customize the web interface as detailed in [Web Client Interface](./3.2-web-client-interface.md)
