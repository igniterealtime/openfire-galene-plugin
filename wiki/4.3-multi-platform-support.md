...
For information about the overall plugin architecture, see [Core Plugin Architecture](/igniterealtime/openfire-galene-plugin/4.1-core-plugin-architecture). For details about the build system that packages these binaries, see [Building from Source](/igniterealtime/openfire-galene-plugin/2.1-building-from-source).
