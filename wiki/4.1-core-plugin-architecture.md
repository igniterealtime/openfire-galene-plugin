...
This document covers the core architecture of the Openfire Galene Plugin, focusing on the main plugin class, its lifecycle management, and integration with Openfire services. For details about the WebSocket proxy system, see [WebSocket Proxy System](/igniterealtime/openfire-galene-plugin/4.2-websocket-proxy-system). For multi-platform support specifics, see [Multi-Platform Support](/igniterealtime/openfire-galene-plugin/4.3-multi-platform-support).
