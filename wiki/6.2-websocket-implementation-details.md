...
For broader architectural context, see [System Architecture](./4-system-architecture.md). For client-side WebSocket integration, see [Client-Side Development](./6.3-client-side-development.md).
