...
This page focuses on the core plugin architecture and development patterns. For detailed information about WebSocket implementation specifics, see [WebSocket Implementation Details](./6.2-websocket-implementation-details.md). For client-side development guidance, see [Client-Side Development](./6.3-client-side-development.md). For configuration options that affect development, see [Plugin Configuration Options](./7.1-plugin-configuration-options.md).
