...
For information about XMPP protocol authentication, see [XMPP Protocol Extensions](/igniterealtime/openfire-galene-plugin/5-xmpp-protocol-extensions). For client-side security implementation details, see [Client-Side Development](/igniterealtime/openfire-galene-plugin/6.3-client-side-development).
