...
For information about the core plugin architecture and lifecycle management, see [Core Plugin Architecture](./4.1-core-plugin-architecture.md). For details about authentication mechanisms used by the proxy system, see [Authentication & Security](./4.4-authentication-and-security.md).
