...
For information about XMPP-based communication protocols, see [XMPP IQ Handlers](./8.2-xmpp-iq-handlers.md). For configuration of these HTTP endpoints, see [Plugin Configuration Options](./7.1-plugin-configuration-options.md).
