...
For plugin-level configuration options that control the Openfire Galene Plugin behavior, see [Plugin Configuration Options](/igniterealtime/openfire-galene-plugin/7.1-plugin-configuration-options).
